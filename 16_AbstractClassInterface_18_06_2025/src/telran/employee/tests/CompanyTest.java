...
class CompanyTest {
    ...
    @Test
    void findEmployyesHoursGreaterThan() {
        Employee[] actual = company.findEmployyesHoursGreaterThan(100);
        Employee[] expected = {firm[0],firm[1],firm[2]};
        assertArrayEquals(expected, actual);
    }

    @Test
    void findEmployyesSalaryBetween() {
        Employee[] actual = company.findEmployyesSalaryBetween(5000,10000);
